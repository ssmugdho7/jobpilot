...
ROLE_SEARCH_TERMS = {
    "web developer": ["web developer", "frontend developer", "react developer", "vue developer", "angular developer", "php laravel", "django developer"],
    "ai engineer": ["ai engineer", "machine learning engineer", "data scientist", "ml engineer", "nlp engineer", "computer vision engineer"],
    "it executive": ["IT executive", "system administrator", "IT support engineer", "network administrator", "devops engineer"],
    "software engineer": ["software engineer", "backend developer", "full stack developer", "python developer", "java developer", "c# developer", "golang developer", "nodejs developer", "rust developer", "typescript developer"],
    "devops or cloud engineer": ["devops engineer", "cloud engineer", "site reliability engineer", "sre", "platform engineer", "kubernetes engineer", "aws engineer", "azure engineer", "gcp engineer", "terraform engineer"],
    "qa analyst": ["QA engineer", "QA analyst", "software tester", "test automation engineer", "sdET", "playwright", "selenium", "cypress"],
    "data analyst": ["data analyst", "business intelligence", "power bi", "tableau", "sql analyst", "data engineer", "etl developer", "analytics engineer"],
    "app developer": ["android developer", "flutter developer", "mobile app developer", "ios developer", "swift developer", "kotlin developer", "react native developer", "xamarin developer"],
    "python developer": ["python developer", "django developer", "fastapi developer", "flask developer", "python backend", "python engineer"],
    "java developer": ["java developer", "spring boot developer", "java backend", "java engineer", "j2ee developer", "microservices java"],
    "c# developer": ["c# developer", ".net developer", "asp.net developer", "dotnet developer", "csharp developer"],
    "golang developer": ["golang developer", "go developer", "go backend", "golang engineer", "microservices go"],
    "react developer": ["react developer", "reactjs developer", "frontend react", "react engineer", "nextjs developer"],
    "nodejs developer": ["nodejs developer", "node.js developer", "nestjs developer", "express developer", "backend nodejs"],
    "flutter developer": ["flutter developer", "dart developer", "flutter engineer", "cross platform developer"],
    "machine learning engineer": ["machine learning engineer", "ml engineer", "mle", "deep learning engineer", "ai researcher", "tensorflow", "pytorch"],
    "data scientist": ["data scientist", "data science", "applied scientist", "ml researcher", "analytics scientist"],
    "data engineer": ["data engineer", "etl developer", "data pipeline engineer", "big data engineer", "spark developer", "kafka engineer"],
    "devops engineer": ["devops engineer", "devops", "ci/cd engineer", "jenkins", "github actions", "gitlab ci", "argocd", "helm"],
    "cloud engineer": ["cloud engineer", "aws engineer", "azure engineer", "gcp engineer", "cloud architect", "infrastructure engineer"],
    "site reliability engineer": ["site reliability engineer", "sre", "reliability engineer", "production engineer", "observability engineer"],
    "qa engineer": ["qa engineer", "test automation engineer", "sdET", "quality assurance engineer", "playwright", "selenium", "cypress", "postman"],
    "database administrator": ["database administrator", "dba", "sql dba", "postgresql dba", "mysql dba", "mongodb dba", "oracle dba"],
    "cybersecurity analyst": ["cybersecurity analyst", "security analyst", "soc analyst", "information security", "penetration tester", "ethical hacker"],
    "blockchain developer": ["blockchain developer", "web3 developer", "smart contract developer", "solidity developer", "rust blockchain", "defi developer"],
    "embedded systems engineer": ["embedded systems engineer", "firmware engineer", "embedded developer", "c embedded", "rtos", "microcontroller"],
    "ui ux designer": ["ui ux designer", "product designer", "ux researcher", "ui designer", "figma", "user experience designer"],
}
